...
class DiskWriter{
    ...
    public:
        ...
        STATUS_CODE const writeToBlock(
        ...
        std::pair<STATUS_CODE, DirectoryBlock*> const chainDirectoryBlock(
            DirectoryBlock* const directory
        );
        WriteResult const addEntryToDirectory(
            DirectoryBlock* const directory, 
        ...
        WriteResult const createToFile(
